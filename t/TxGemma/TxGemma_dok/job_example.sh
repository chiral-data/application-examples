...
wget https://raw.githubusercontent.com/chiral-data/application-examples/refs/heads/v0.2.4/t/TxGemma/TxGemma_dok/example.py -O example.py 2>&1 | tee -a "$OUTPUT_FILE"
