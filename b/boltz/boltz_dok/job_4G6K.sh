...
wget https://raw.githubusercontent.com/chiral-data/application-examples/refs/heads/v0.2.4_boltz2lightdock/b/boltz/boltz_dok/input_antibody_antigen/4G6K_rec.fasta -O 4G6K_rec.fasta
wget https://raw.githubusercontent.com/chiral-data/application-examples/refs/heads/v0.2.4_boltz2lightdock/b/boltz/boltz_dok/input_antibody_antigen/4G6K_lig.fasta -O 4G6K_lig.fasta
